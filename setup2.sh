...
function install_xray(){
    ...
    xraycore_link="https://github.com/Shan0h/Xcore-custompath/releases/download/Xray-linux-64-v1.6.5.1/Xray-linux-64-v1.6.5.1"
...
########## SETUP FROM HERE ##########
# ORIGINAL SCRIPT BY FEVER DREAM   #
#####################################
